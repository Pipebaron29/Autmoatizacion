...
public class hirePass1Task implements Task {

    private static String busNombre;
    private static String Nombre;


    public hirePass1Task(String busNombre, String Nombre) {
    ...
    public static Performable data( String busNombre, String Nombre) {
        return instrumented(hirePass1Task.class, busNombre, Nombre);
    }
